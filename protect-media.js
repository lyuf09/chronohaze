(function () {
  ...
  function applyHakoniwaLyricsInEnglish(safeLang) {
    ...
    var part1Blocks = [
      ...
      {
        zh: ["色の重なり合い、曇った硝子の反射", "カメラの閃きに振り返ったこと", "夜明け前の輪郭に縋りついていた"],
        en: [
          "Layers of colour,",
  ...
  function applyIHateYouAllLyricsInEnglish(safeLang) {
    ...
    var part1Blocks = [
      ...
      {
        zh: ["あたし", "わからない、わからない", "正解なんて私が知るもんか", "「大人になってない」も言い訳", "これも嫌なんだ"],
        en: [
          "Me—",
